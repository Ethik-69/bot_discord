...
async def get_flux(context):
    ...
    result = list(rdb.db(db_name).table(site_table_name).run(connection))
    ...
    for site in result:
        ...
        for entrie in rss_feed["entries"]:
            ...
            if result == 0:
                ...
                channel = get_channel(site["channel_name"])
...
async def remove_all_articles(context):
    ...
    try:
        ...
        logger.exception(503, "No database connection could be established.")
